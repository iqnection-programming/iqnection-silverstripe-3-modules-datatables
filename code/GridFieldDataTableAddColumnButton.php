 ...
 *
 */
class GridFieldDataTableAddColumnButton extends Object implements GridField_HTMLProvider, GridField_ActionProvider {
	 ...
	 * @var array
	 */
	protected $modelClass = 'DataTableColumn';
	...
	public function getHTMLFragments($grid) 
	{
		...
		if(!$buttonName) {
			...
			$buttonName = _t('GridField.Add', 'Add New {name}', array('name' => $objectName));
		}
